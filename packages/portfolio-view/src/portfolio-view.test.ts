...
import { INDEXER_ABSENT, INDEXER_READMODELS_UNBUILT, portfolioViewFromLedgerBalances, portfolioViewSchema } from './portfolio-view.js';

const USER = 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa';

describe('portfolioViewFromLedgerBalances — ops.portfolio Stage-1', () => {
  it('names a missing indexer absent, never a zero chain balance', () => {
    ...
    expect(view.indexer).toEqual({ status: 'absent', reason: INDEXER_READMODELS_UNBUILT });
