...
| ⛔ | AMM pools from audited templates <br/>_Updated 2026-07-31 residual: compile + deploy-dev PoolFactory + mint/swap onchain suite (TokenFactory tokens → mint LP → swapExactIn on anvil when REQUIRE_EVM_CHAIN). Still not done: no audit, no prod factory, funding/router product. _ | P | `protocol.smart-accounts` | `protocol.amm` |
