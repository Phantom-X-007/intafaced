...
| `EDGE_BODY_LIMIT_BYTES`                | max request body the edge will parse. Required (blank refuses boot, never 1048576). Owner may set 1048576. Oversize → 413 before principal exchange or upstream work. |
