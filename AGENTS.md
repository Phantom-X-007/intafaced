...
5. Do not rebuild the product SPA or a **second money book**. Prefer existing shell + ledger + `svc-*`. **Internet leverage law:** [`docs/INTERNET-LEVERAGE-LAW.md`](docs/INTERNET-LEVERAGE-LAW.md). Exchange OSS take/keep/never: [`PRO_TRADER_EXCHANGE_DEFINITIVE_SCOPE.md`](PRO_TRADER_EXCHANGE_DEFINITIVE_SCOPE.md) **§0.3**. Live-wire + depth **v1.23**: [`docs/SPEC-PRO-EXCHANGE-LIVE-AND-DEPTH-2026-09-02.md`](docs/SPEC-PRO-EXCHANGE-LIVE-AND-DEPTH-2026-09-02.md) + [`docs/SPEC-PRO-EXCHANGE-BUILDER-CARDS-2026-09-02.md`](docs/SPEC-PRO-EXCHANGE-BUILDER-CARDS-2026-09-02.md) + [`docs/SPEC-PRO-EXCHANGE-RITEM-INVENTORY-2026-09-02.md`](docs/SPEC-PRO-EXCHANGE-RITEM-INVENTORY-2026-09-02.md). Do not hand-roll FIX/SBE/Greeks. Do not install npm `ccxt` or a second CLOB.
