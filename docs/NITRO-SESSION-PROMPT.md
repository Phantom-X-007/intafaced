...
- **Truth layers (binding — do not collapse):** docs/COORDINATION-TRUTH-LAYERS.md — product free/owner/done = features.mjs; campaign next = BOARD-CLEAR-NEXT; session dual-build = LIVE-LANES + open PRs; code = git. Tracker touch = mountain events only (not every craft PR). No new Approve gates / PR caps / CI tax.
