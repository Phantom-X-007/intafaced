...
| 🟢 | Internal market-maker seeding books at launch <br/>_Updated 2026-07-31 residual: research pack + pure seed planner (planSeedQuotes) — external mid only, never invent. Still missing: seeder job with house money path (ledger house/market-maker), explicit market list, ops enable. Not done._ | F |  | `trade.mm-bot` |
