...
export function BackgroundBeams({ className }: { className?: string }) {
  return (
    <div className={cn('pointer-events-none absolute inset-0 overflow-hidden', className)} aria-hidden>
      <div className="absolute -top-1/3 right-[-10%] h-[70%] w-[55%] rounded-full bg-[radial-gradient(circle,rgba(198,255,61,0.16),transparent_65%)] blur-2xl animate-pulse-slow" />
      ...
      <svg className="absolute inset-0 h-full w-full opacity-[0.18]" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="beam" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="50%" stopColor="#c6ff3d" stopOpacity="0.55" />
