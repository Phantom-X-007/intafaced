...
| 🔨 | Perps: cross/isolated margin, funding, liquidation ladder <br/>_Updated 2026-07-31 residual: full futures residual stack + startFuturesJobs wired (default OFF; TRADE_FUTURES_JOBS_ENABLED + explicit market ids). Still missing: live multi-venue index oracle, matching seed, ops enable. Not done._ | F |  | `trade.futures` |
