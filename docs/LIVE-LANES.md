...
**Not free:** Shehzad protocol/chain implement · dual-edit Denon open files · invent money/depth · Class X · front-end under `nitro-frontend-all` · platform-pages dual-start without foundation/craft split.
