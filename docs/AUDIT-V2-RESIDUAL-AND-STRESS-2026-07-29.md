...
| **Cross-family second eye** (Claude ↔ Grok/Codex) | ~93% findings unique per reviewer family in 2026 multi-tool study | P1 money |
...
| **ShopPay-style checklist** ([shoppay-audit-benchmark](https://github.com/Dmatut7/shoppay-audit-benchmark) as *calibration*, not dependency) | Business-logic IDOR/webhook/double-spend patterns | L3 agent prompts |
