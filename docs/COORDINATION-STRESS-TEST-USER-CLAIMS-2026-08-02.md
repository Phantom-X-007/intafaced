...
**Bottom line for you:** Right *user* outcome (no homework, no slowdown) is correct. Wrong mental model if you picture a silent machine that always keeps the board true without agents.
