...
describe('every private stream opens only after the newly enrolled passkey verifies following last-unenroll', () => {
  let server: Server;
  ...
  it('unverified newly enrolled cred refuses every upgrade', async () => {
