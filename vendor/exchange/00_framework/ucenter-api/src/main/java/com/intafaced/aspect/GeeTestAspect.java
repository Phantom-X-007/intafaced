...
import com.intafaced.exception.GeeTestException;
import com.intafaced.service.LocaleMessageSourceService;
import com.intafaced.system.GeetestLib;
...
public class GeeTestAspect {
 ...
 // "||execution(public * com.intafaced.controller.SmsController.resetPasswordCode(..))"+
    @Pointcut("execution(public * com.intafaced.controller.RegisterController.registerByEmail(..))"+
            "||execution(public * com.intafaced.controller.RegisterController.sendResetPasswordCode(..))")
    public void geeTest() {
    	
    }
    @Pointcut("execution(public * com.intafaced.controller.SmsController.sendCheckCode(..))")
