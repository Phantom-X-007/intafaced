...
| 🔨 | Perps: cross/isolated margin, funding, liquidation ladder <br/>_Updated 2026-07-31 residual: full stack + jobs wire (OFF) + public funding-rate for futures only when rate published (never invent 0). Still missing: live multi-venue index, matching seed, ops enable. Not done._ | F |  | `trade.futures` |
