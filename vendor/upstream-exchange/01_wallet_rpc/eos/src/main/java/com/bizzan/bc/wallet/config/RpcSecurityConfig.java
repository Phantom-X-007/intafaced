 ...
 *
 * <p>What this module exposes without it: the controller declares no handlers
 * today, but it is mapped at /rpc and this interceptor covers every path under
 * the context root — anything the classpath mounts, now or later, is behind the same wall.
 *
