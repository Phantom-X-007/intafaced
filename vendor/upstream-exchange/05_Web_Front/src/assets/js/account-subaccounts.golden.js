#!/usr/bin/env node
/**
 * Fail-first golden for /uc/account sub-account create.
 * Run from 05_Web_Front: node src/assets/js/account-subaccounts.golden.js
 *
 * List-only is occupancy. Create must hit identity.subAccounts.create.
 * Empty list is empty copy, not "0". No ledger posts on this screen.
 */
'use strict';
