/**
 * Merchant acquiring scope grant — mechanism shape (D26-P0-08).
 *
 * Law: DIRECTION §8 item 4 / §3 merchant onboarding — who grants `pay:*` and
 * after what KYB check is OWNER-ONLY. This module is the refuse-closed door so
 * D26-P1-P10 can wire without inventing a grantor.
 *
 ...
 *
 * Tip behaviour: always refuse. Owner-published grant law (D26-P1-P10) replaces
 * the body; call sites keep this contract.
 *
