...
`█████░░░░░░░░░░░░░░░` **27%** — 29 of 107 features shipped

Phases: **0** 10/11 · **1** 7/14 · **2** 5/17 · **3** 4/16 · **3P** 0/7 · **4** 1/5 · **4P** 0/3 · **5** 2/32 · **5P** 0/2

**In progress:** WebAuthn registration + assertion (§9) (Nitro) · One-tap Convert — the retail on-ramp (Nitro) · WebSocket fan-out: depth, trades, orders, positions (Nitro) · Branded gateway, hosted checkout, payment links (Nitro)
