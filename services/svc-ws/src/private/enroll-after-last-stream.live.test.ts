...
describe('private stream drops unless the newly enrolled passkey verifies following last-unenroll', () => {
  let server: Server;
  ...
  it('newly enrolled stays open, then drops on heartbeat if none remain', async () => {
