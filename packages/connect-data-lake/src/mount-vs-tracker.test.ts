...
describe('connect.data-lake done bar files complete (D71)', () => {
  it('dataLakeDoneBarTestsPresent locks every DATA_LAKE_DONE_BAR_TEST_FILE on disk', () => {
    expect(dataLakeDoneBarTestsPresent()).toBe(true);
    expect(DATA_LAKE_DONE_BAR_TEST_FILES).toHaveLength(12);
...
describe('connect.data-lake mount vs tracker — D74 denon complete', () => {
  it('stage1, capture, persistence, exports, done-bar tests, and honest gaps board all green', () => {
    ...
    expect(dataLakeDoneBarTestsPresent()).toBe(true);
    expect(dataLakeExportsInIndexSource()).toEqual([...DATA_LAKE_PACKAGE_EXPORTS]);
    expect(DATA_LAKE_HONEST_GAPS).toHaveLength(0);
  });
});
...
describe('connect.data-lake mount vs tracker — D98 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D100 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D102 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D104 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D106 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D108 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D110 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D112 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D114 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D116 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D118 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.data-lake mount vs tracker — D120 denon complete', () => {
  it('full mount board: stage1, capture, persistence, exports, done-bar tests, honest gaps', () => {
    expect(DATA_LAKE_TRACKER_ID).toBe('connect.data-lake');
    const card = connectDataLakeMountVsTrackerBoardCard();
    expect(card).toMatchObject({
