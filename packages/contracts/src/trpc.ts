 ...
 * `denied.region_blocked`, `denied.region_unknown`, `denied.screening_unconfigured`,
 * `denied.module_blocked`, `denied.plane_unsupported` — out to the caller. Before it, a matrix refusal
