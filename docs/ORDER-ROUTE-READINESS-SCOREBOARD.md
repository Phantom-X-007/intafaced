...
| CEX assembled            | **CI path**      | order-path-cx8 workflow + edge place/cancel   | L3 two-user residual; not Human X        |
...
**Last update:** 2026-08-02 — CX-8 CI assembled proof path (B-layer). **Not go-live. Not stable-for-real-money.**
