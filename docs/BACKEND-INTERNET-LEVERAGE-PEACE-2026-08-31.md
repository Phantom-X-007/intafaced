...
| OpenAPI from Zod (`PTX-M05-R08`)       | `@asteasolutions/zod-to-openapi` (or current maintained Zod 3 generator)  | We already own Zod contracts.                                                                                                 | Generate from `packages/contracts`.                                                                                                           | A second schema language                                        |
