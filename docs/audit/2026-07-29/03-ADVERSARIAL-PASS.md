...
| **G3 Coverage metrics** | Strong qualitative layers; incomplete public-procedure *counts* vs checked | Census: procedures / routes / money journeys with N/M |
...
**Not a failure of wave-1 purpose** — wave-1 found and fixed real open doors. It is incomplete as *proof diversity*. V2 closes that.
