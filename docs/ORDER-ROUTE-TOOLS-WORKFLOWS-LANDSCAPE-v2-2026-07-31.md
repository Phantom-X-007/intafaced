...
3. **r/SpecDrivenDevelopment + coding-agent communities + r/AI_Agents** are active discussion homes — SDD is a _community_, not a blog fad.
...
| Full Jepsen multi-node day-1                      | Steal _tests design_; infra cost later           |
