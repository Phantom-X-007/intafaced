...
| Vendor shell + admin + major Java                    | High-level V-JAVA                                        | Path is **`vendor/upstream-exchange`**; modules: admin, chat, cloud, core, exchange, exchange-api, exchange-core, market, otc-*, ucenter-api, wallet, bitrade-job, sql, jar | **PARTIAL** — abstract OK, module list thin |
