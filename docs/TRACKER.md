...
| 🔨 | Perps: cross/isolated margin, funding, liquidation ladder <br/>_Updated 2026-07-31 residual: planners/ticks/close/job-host/marks + SQL loaders + durable funding_periods/liquidation_attempts stores + sqlPositionCloser. Still missing: live multi-venue index, matching seed, ops cron enable. Not done._ | F |  | `trade.futures` |
