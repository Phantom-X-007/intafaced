      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          <div class="item" @click="showCardItem">
              <img src="/static/2019/promotioncard.png"></img>
          ...
          <div class="item" @click="useInviteImage">
              <img src="/static/2019/invitebg.jpg"></img>
...
export default {
  ...
  methods: {
    ...
    saveInviteImage(){
      this.save("inviteImage", "Invite image");
    ...
    save(divText, imgText) {
        ...
        html2canvas(canvasID, {
          ...
          height: canvasID.offsetHeight * scale
            ...
            // []Close https://segmentfault.com/a/1190000011478657
