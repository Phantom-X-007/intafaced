...
| 🔨 | Perps: cross/isolated margin, funding, liquidation ladder <br/>_Updated 2026-07-31 residual: full planner/tick/close/job-host/mark stack + SQL position loaders for ticks. Still missing: live multi-venue index, matching seed, ops cron enable. Not done._ | F |  | `trade.futures` |
