...
export const FEATURES = [
  ...
  f('trade.futures', 'Perps: isolated margin, funding, partial-liquidation ladder', {
    ...
    note:
      'WIP 2026-08-12 Denon D26-P1-T1c (feat/futures-partial-liquidation / #1681): partial liq vs real EngineDepth book — min close restores maintenance; ' +
      'ledger recipe only (futures.loss.realized); empty book skips; GET /positions observes reduced size. ' +
      'Also sealed: #1679 T1f funding nets zero + #1678 T1b margin-call observe. Isolated margin ONLY. Orderable only when TRADE_FUTURES_ENABLED (default OFF). Same svc-matching book (D-S-06). ' +
      ...
      '#1672 T1a mark law, #1670 insurance list gate, #1678 T1b, #1679 T1f. ' +
      'Still not umbrella-done: T1d–T1e, T1g, leveraged entry product, funding jobs OFF default + owner §8 rates/ceilings, ' +
