...
| **D26-P3-08** | **Observability: alerts + one real dashboard** | Honesty: [`docs/ops/D26-P3-08-OBSERVABILITY-ALERTS-DASHBOARD-HONESTY-2026-08-15.md`](ops/D26-P3-08-OBSERVABILITY-ALERTS-DASHBOARD-HONESTY-2026-08-15.md) — compose Grafana `edge-slo.json` + edge `/metrics` scrape **real**; hosted dashboard **named-absent**; alert routes **none configured** (refuse paging). No invented SLO numbers. | Run                               |
