...
5. Internet leverage: read `docs/INTERNET-LEVERAGE-LAW.md` before product code. Prefer Phase A in-repo assets (shell, ledger, `svc-*`). Named take/keep/never is north-star **§0.3** + `docs/BACKEND-INTERNET-LEVERAGE-PEACE-2026-08-31.md`. Live-wire + depth v1.23: `docs/SPEC-PRO-EXCHANGE-LIVE-AND-DEPTH-2026-09-02.md` + `docs/SPEC-PRO-EXCHANGE-BUILDER-CARDS-2026-09-02.md` + `docs/SPEC-PRO-EXCHANGE-RITEM-INVENTORY-2026-09-02.md`. FIX/SBE/Greeks/WebAuthn/OpenAPI-from-Zod are **EXT adapters**, not vibe-code. Phase B `trade.ccxt-api` is an API **shape**; npm `ccxt` stays banned.
