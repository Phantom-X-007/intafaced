...
var listening = freshness.streamState('ok', [{ time: 1725000000 }], 'listening');
...
assert(exchange.indexOf('svc-trade REST snapshot') >= 0 && exchange.indexOf("state.live ? 'live'") >= 0, 'desk labels snapshot and live stream states');
