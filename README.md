...
**In progress:** PII isolation — KYC documents in a separate encrypted store (§10) (ZenYoda3) · Drop phases 0–V as feature flags — waitlist, referral queue, founding badges, season engine (§11) (ZenYoda3) · Multi-tier affiliate / IB trees, payout automation (agent:w13-l04) · Screening queues, geo-block, VPN/Tor detection (w10-l04-edge) · Warehouse — read replica + cube layer (w10-l04-edge) · Event-driven fan-out: in-app, push, email, SMS (w13-l12-notify)
