...
## What changed (Claude was right)

| Old Day-0 story                                        | New truth                                                                                                  |
| ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| Nitro must launch Chrome + install chrome-devtools-mcp | **Not required for normal Stream A proof**                                                                 |
| Browser blocked by macOS / Playwright                  | Claude Code shell sandbox blocks loopback; **Orca embedded browser bypasses that** (app does the browsing) |
...
| Role                                      | Tool           |
| ----------------------------------------- | -------------- |
| Plan / audit / money certify              | Claude Opus    |
