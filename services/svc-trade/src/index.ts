...
registerPublicRest(app, {
  markets: (status, kind, quote, base) => trade.markets(status, kind, quote, base),
  marketBySymbol: (symbol) => trade.marketBySymbol(symbol),
  depth: (marketId, limit) => matching.depth(marketId, limit),
  publicTape: (marketId, limit, sinceMs, side, untilMs) => trade.publicTape(marketId, limit, sinceMs, side, untilMs),
  candles: (marketId, timeframe, limit, sinceMs, untilMs) => trade.candles(marketId, timeframe, limit, sinceMs, untilMs),
...
registerPrivateRest(app, {
  ...
  serviceName: env.SERVICE_NAME,
  openOrders: (principal, marketId, status, side, type, tif, clientOrderId) =>
    trade.openOrders(principal, marketId, status, side, type, tif, clientOrderId),
  ...
  myFills: (principal, limit, marketId, sinceMs, side, liquidity, orderId, counterOrderId) =>
    trade.myFills(principal, limit, marketId, sinceMs, side, liquidity, orderId, counterOrderId),
  marketBySymbol: (symbol) => trade.marketBySymbol(symbol),
  ...
  listPositions: (principal, symbol, status, side) => positions.listOpen(principal.userId, symbol, status, side),
