/**
 * API-key expiresAt on `/private/stream`.
 * Past expiresAt drops the seat. Missing clock refuses. Never invent an expiry.
 */
...
/** Identity body only. Never invent an expiry. */
...
/** After expiresAt the stream drops. Missing expiry stays open. Missing clock refuses. */
