...
| **Upgrade**          | AFK integrity **cycle85** on tip `949b3b99`. Freeze **still true**: open **#433** matching + **#432** edge (re-verified OPEN). **#424** / **#422** remain MERGED. Prior stamps: `2f009f54` (cycle82 / #652), `fa367739` (cycle81), `6ae7c658` (cycle80 / #649), `d36b2823` (#649 base). **NO implement** / **NO-FLEET**. **No depth UI.** |
