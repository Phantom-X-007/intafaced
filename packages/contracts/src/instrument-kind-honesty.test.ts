...
describe('L3 wave151 instrument kind catalog honesty', () => {
  it('kind catalog boards', () => {
    ...
    expect(instrumentKindCatalogStatusLineConsistent(instrumentKindCatalogStatusLine())).toBe(
      true,
    );
    expect(instrumentKindCatalogExportText().startsWith(instrumentKindCatalogExportHeader())).toBe(
      true,
    );
