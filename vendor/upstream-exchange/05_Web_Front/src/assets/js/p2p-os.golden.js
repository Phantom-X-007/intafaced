...
has(market, 'class="content-wraps otc-desk"', 'market shell');
has(market, 'class="otc-os-header"', 'market header');
has(market, 'to="/p2p">Operations', 'market operations link');
has(market, '<IxState compact', 'market refusal state');
has(market, '<details class="otc-market-notes">', 'market disclosure');
