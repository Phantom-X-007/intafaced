...
| 🔨 | WebSocket fan-out: depth, trades, orders, positions <br/>_Depth + public TRADE tape + private orderUpdated stream (/private/stream, JWT optional). Positions still missing._ | F |  | `ws.gateway` |
