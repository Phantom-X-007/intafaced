...
| 🔨 | Perps: cross/isolated margin, funding, liquidation ladder <br/>_Updated 2026-07-31 residual: F1–F5 recipes + open/close+bus + funding/liq planners+ticks + mark-source + funding-rate-source ports (never invent; stale/empty → skip). Still missing: real index/funding oracles productized, wall-clock cron hosts, matching engine, realized PnL on close. Not done._ | F |  | `trade.futures` |
