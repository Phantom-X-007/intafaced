...
public final class TradeEncoder
{
    ...
    public TradeEncoder instrument(final int index, final byte value)
    {
        if (index < 0 || index >= 16)
        {
    ...
    public TradeEncoder putInstrument(final byte[] src, final int srcOffset)
    {
        final int length = 16;
    ...
    public TradeEncoder instrument(final String src)
    {
        final int length = 16;
    ...
    public TradeEncoder instrument(final CharSequence src)
    {
        final int length = 16;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public TradeEncoder eventTimeNs(final long value)
    {
