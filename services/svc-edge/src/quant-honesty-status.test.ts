...
describe('quant honesty door status — denon board complete (D101)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D103)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D105)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D107)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D109)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D111)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D113)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D115)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D117)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
...
describe('quant honesty door status — denon board complete (D119)', () => {
  it('full quant honesty mount board: doors, packages, flags, data-lake alignment', () => {
    const status = describeQuantHonestyDoorStatus();
    expect(status.mountedOnControlPlane).toBe(true);
    expect(status.notProxiedToSvcQuant).toBe(true);
