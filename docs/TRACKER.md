...
| 🔨 | Perps: cross/isolated margin, funding, liquidation ladder <br/>_Updated 2026-07-31 residual: F1–F5 recipes + positions open/close+bus + funding/liq planners + liquidation-tick job (external mark only). Still missing: mark oracle product, wall-clock cron hosts, matching engine, realized PnL on close. Not done._ | F |  | `trade.futures` |
