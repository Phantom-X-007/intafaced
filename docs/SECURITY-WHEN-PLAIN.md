...
**Product doors from the full audit are closed on main (#80/#81).** Everyday security *tooling* is still only **partial** — see security floor.
...
2. **Concurrent smoke** — many withdraw/hold-style actions at once (this *is* stress-style testing).  
