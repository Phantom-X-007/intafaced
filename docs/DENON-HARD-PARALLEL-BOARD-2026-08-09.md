...
| **D26-P2-04**  | **Fleet real image rebuild runbook**                   | **SHIPPING** — `docs/ops/FLEET-TIP-IMAGES.md` + `pnpm fleet:tip-images`; local `--build` / staging digest `--no-build`; no second image kit                       |
