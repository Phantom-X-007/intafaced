...
| A2   | created timeout re-drive residual | stuck `created` deals re-drive or expire; no eternal escrow ghost |
| A2   | sweepSettlements residual         | settlement sweep idempotent; double-run pays once                 |
| A2   | escrowIntegrity residual          | ledger escrow vs deal state agree; RED on drift                   |
| A3   | reputation/XP residual            | XP cannot invent rank that unlocks money; park law-thin pieces    |
