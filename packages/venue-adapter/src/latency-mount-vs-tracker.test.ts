...
describe('connect.latency-grading mount vs tracker — D89 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card).toMatchObject({
...
describe('connect.latency-grading mount vs tracker — D91 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D93 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D95 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D97 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D99 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D101 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D103 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D105 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D107 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D111 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D113 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D115 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D117 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
...
describe('connect.latency-grading mount vs tracker — D119 denon complete', () => {
  it('full mount board: symbols, SOR consumer, done-bar tests, honest gaps', () => {
    expect(LATENCY_GRADING_TRACKER_ID).toBe('connect.latency-grading');
    const card = latencyGradingMountVsTrackerBoardCard();
    expect(card.backendDoneBarMet).toBe(true);
