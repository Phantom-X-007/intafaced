...
| `vendor/coinexchange/05_Web_Front` | The **deployed** trading shell, `:8090` (`docker-compose.apps.yml:718-728`), 71 `.vue` files, the target of 7 of the last 12 merges                                               | **none** | —                                                                                                                                |
| `vendor/coinexchange/04_Web_Admin` | 92 `.vue` staff console, has a real `build` script, in **neither** compose file, **no `# no-deploy:` reason**                                                                     | **none** | —                                                                                                                                |
