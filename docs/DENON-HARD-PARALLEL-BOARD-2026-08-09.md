...
| **D26-P0-09** | **Fee + revenue recipe map** (which recipes exist)        | ~~agents invent ledger recipes~~ **SEALED** — closed matrix on tip (#1732)                                                                                                    | Every fee path → named recipe or §13. Do not invent recipes.                                                                                                                                                                        |
