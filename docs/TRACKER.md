...
| 🔨 | Perps: cross/isolated margin, funding, liquidation ladder <br/>_Updated 2026-07-31 residual: F1–F5 + planners/ticks + mark/rate ports + futuresRealizeProfit + close planner (external exit; never invent). Still missing: wire PositionService.close to planner, live oracles, cron, matching. Not done._ | F |  | `trade.futures` |
