...
| 🟢 | Internal market-maker seeding books at launch <br/>_Updated 2026-07-31 residual: research + planSeedQuotes + seedMarket + ops job host default OFF (TRADE_MM_SEED_*, empty books only, env mids). Still missing: house tradeFill on MM fills, cancel/reseed lifecycle, live mid oracle. Not done._ | F |  | `trade.mm-bot` |
