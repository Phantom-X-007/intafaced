 ...
 *
 * <p>What this module exposes without it: GET /rpc/address/{account} mints a
 * fresh secp256k1 private key with {@code new ECKey()} and writes it into an
 * unencrypted bitcoinj wallet file; GET /rpc/withdraw and GET /rpc/transfer move
 * coins out of the hot wallet.
 *
