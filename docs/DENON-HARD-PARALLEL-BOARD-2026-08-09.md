...
| **D26-P1-O2** | ops.affiliates    | ~~Accrual tree under rate authority~~ **SEALED 2026-08-12** — durable accrue under owner IDENTITY_AFFILIATE_ACCRUAL_TIERS_JSON only; unset → ffiliate.accrual.rates_unset; per-call invent → ffiliate.accrual.invent_refused; payout stays existing ledger recipes |
