...
**Depends on:** `launch.token-factory` · `token.staking`  
...
Product complete for: Presale / fair launch, vesting, staked allocation tiers.  
Depends factory + staking; full pad not built.
