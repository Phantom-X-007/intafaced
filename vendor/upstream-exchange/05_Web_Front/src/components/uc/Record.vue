      ...
      <div class="bill_flow_box">
        <div class="rightarea-con">
          <div class="form-group">
            ...
            <Button type="warning" @click="queryOrder" style="padding: 6px 30px;margin-left:10px;background-color:#c8c8c8;border-color:#c8c8c8">{{$t('uc.finance.record.search')}}</Button>
          </div>
