...
**Last scoreboard edit:** 2026-08-01 M1 Pay OS gateway ship (shehzad) · prior wave1 audit after #289+#336+#337+#338  
**Known dirty:** #338 mm recovery in CI; human M1–M7 open (M1 gateway PR shipping)  
...
| pay.gateway (+ pay.* expand)     | **WIP**  | **HUMAN M1 shehzad002**  | gateway Done bar shipping (card sandbox + KYB stub + list); expand pay.* next | M1 Pay OS           | feat/pay-os-m1-gateway |
