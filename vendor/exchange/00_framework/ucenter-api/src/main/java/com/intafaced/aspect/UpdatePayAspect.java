...
import com.intafaced.service.AdvertiseService;
import com.intafaced.service.LocaleMessageSourceService;
import com.intafaced.service.OrderService;
...
public class UpdatePayAspect {
    ...
    @Pointcut("execution(public * com.intafaced.controller.ApproveController.updateAli(..))"+
            "||execution(public * com.intafaced.controller.ApproveController.updateBank(..))"+
            "||execution(public * com.intafaced.controller.ApproveController.updateWechat(..))")
