...
**Product UI:** `vendor/coinexchange/05_Web_Front` → intended **http://localhost:8090** (compose) or host dev **:8080**  
...
| Chart datafeed | vendored TV + `datafeed/bitrade.js` | Empty history until seed/feed |
