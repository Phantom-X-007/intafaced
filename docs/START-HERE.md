...
- **Order-route / DEX–CEX harden (Denon call · Build next):** [`ORDER-ROUTE-PROGRAM-INDEX.md`](ORDER-ROUTE-PROGRAM-INDEX.md) — Spec/Plan/Architect/tools; engine order **seed-first** (not futures-first).
