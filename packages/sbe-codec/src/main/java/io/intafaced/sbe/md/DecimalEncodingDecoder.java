...
/**
 * Exact decimal: mantissa × 10^exponent. Never IEEE.
 */
@SuppressWarnings("all")
public final class DecimalEncodingDecoder
{
    ...
    public DecimalEncodingDecoder wrap(final DirectBuffer buffer, final int offset)
    {
