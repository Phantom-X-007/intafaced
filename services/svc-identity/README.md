...
| `createOrg`                                            | `identity:write`          | Named org; creator is owner. No balance.                                                                                                                                                      |
| `addOrgMember`                                         | `identity:write`          | Owner adds a user. Missing org/member id refuses. Membership in A cannot add into B.                                                                                                          |
| `assertOrgActor`                                       | `identity:write`          | Actor must belong to the named org. Member of A cannot act as B.                                                                                                                              |
