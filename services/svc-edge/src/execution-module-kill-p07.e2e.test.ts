...
/**
 * P-07 — execution module killable from the same operator surface (non-custodial).
 * Same harness as control-plane.e2e.test.ts: real /admin/kill-switches, stub upstream.
 */
