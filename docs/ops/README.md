...
**Law:** [`../SWARM-ALL-OUT-ORIENT-2026-08-03.md`](../SWARM-ALL-OUT-ORIENT-2026-08-03.md)  
**Wave 1 tools:** `pnpm swarm:freeze` · `swarm:status` · `swarm:report` · `swarm:next`

| File                                       | How it appears                               |
| ------------------------------------------ | -------------------------------------------- |
| [DASHBOARD.md](./DASHBOARD.md)             | `pnpm swarm:report` — Nitro one-screen fleet |
| [FREEZE-LIVE.md](./FREEZE-LIVE.md)         | `pnpm swarm:freeze` — free vs blocked claims |
