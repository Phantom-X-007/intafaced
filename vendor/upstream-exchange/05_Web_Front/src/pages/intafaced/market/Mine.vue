...
export default {
  ...
  data() { return { nav: MARKET_NAV, form: { displayName: '', description: '' }, vendor: this.emptySection(), listings: this.emptySection(), purchases: this.emptySection(), apply: this.emptyAction() }; },
  ...
  methods: { applyVendor() { this.act('apply', mutate('market', 'applyAsVendor', { displayName: this.form.displayName, description: this.form.description }, this.ixToken)).then(() => { this.load('vendor', query('market', 'mine', undefined, this.ixToken)); }); } }
};
</script>
