 ...
 *
 * <p>What this module exposes without it: GET /rpc/height today; this interceptor
 * covers every path under the context root, so anything the classpath mounts,
 * now or later, is behind the same wall.
 *
