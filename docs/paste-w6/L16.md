...
| A2   | wallet_rpc deps residual             | wallet_rpc dep bumps compile-proof or close; no blind merge |
| A2   | framework deps residual              | framework bumps green or hold with reason                   |
| A3   | Boot 2/3 upgrade residual            | multi-month park                                            |
| A3   | scan ratchet residual                | no growth                                                   |
| A3   | stop note supply matrix              | stop note lists supply scan matrix + HOLD list              |
