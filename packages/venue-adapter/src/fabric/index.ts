 ...
 *   · `payout-grade.ts` — absolute best-level notional floor; adapters refuse
 *     thin / one-sided / empty books rather than serving dust as liquidity
 *     (D26-P1-T8). Same placeholder as svc-trade's mark-from-depth floor.
