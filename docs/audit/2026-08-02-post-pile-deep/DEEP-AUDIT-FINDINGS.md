...
| Sev         | Item                                              | Status                                     |
| ----------- | ------------------------------------------------- | ------------------------------------------ |
| P0 residual | Admin BFF unauthenticated (shared token)          | **Named** in runbook/board — SSO still ops |
...
| P1          | Kill state not durable multi-replica              | **Open** — §13                             |
...
Continue archive: `DEEP-AUDIT-CONTINUE-2026-08-02.md`
