...
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `socket.contract-toolchain`       | **Partly closed.** solc-js compile + anvil CI remain. Forge fuzz + gas ceilings in `test/forge` (`pnpm test:forge`). Still open: session-key escalation / spend-limit re-entrancy forge suite, `validateUserOp` session-op refusal richness, external audit |
